...
- The macOS arm64 PyInstaller build passed the direct and packaged MCP contract suite. The suite also covered paths containing spaces, read-only package locations, concurrent clients, reproducible MCPB archives, credential scans, and data preservation after package removal.
